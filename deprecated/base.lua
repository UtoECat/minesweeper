...
function recs_collision(a, b) --
	if a == b then return nil end;
	if a.x < b.x+b.w and
    b.x < a.x+a.w and
    a.y < b.y+b.h and
    b.y < a.y+a.h then return a else return nil end;
end;

function recss_collision(a, b) --
	if a == b then return nil end;
	if a.x < b.x+b.w and
    b.x < a.x+a.s and
    a.y < b.y+b.h and
    b.y < a.y+a.s then return a else return nil end;
end;

local m = {x = 0, y = 0, w = 1, h = 1}

function mouse_collision(a) m.x = love.mouse.getX(); m.y = love.mouse.getY(); return recs_collision(a,m) end;
...
function vec.angle (a, b, c, d) -- calculate angle in X-axis
	local result = math.atan2(d - b, c - a)*(180.0 / 3.1415);
